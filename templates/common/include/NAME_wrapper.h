...
*/
#ifndef _NAME_WRAPPER_H_
#define _NAME_WRAPPER_H_
...
namespace osm_diff_analyzer_NAME
{
  ...
  public:
    ...
    static osm_diff_analyzer_if::analyzer_description_if * get_NAME_description(void);
    static osm_diff_analyzer_if::general_analyzer_if * create_NAME_analyzer(const osm_diff_analyzer_if::module_configuration * p_conf);
    static void require_common_api(osm_diff_analyzer_if::module_library_if::t_register_function);
    static void cleanup(void);
  private:
    static NAME_common_api *m_common_api;
  };

}
#endif // _NAME_WRAPPER_H_
//EOF
